...
class History : AppCompatActivity() {
    ...
    private fun updateData(){
        ...
        if (firstName.isNotEmpty() && lastName.isNotEmpty() && rollNo.isNotEmpty()){
            ...
            Toast.makeText(this@History,"Запись изменина", Toast.LENGTH_SHORT).show()
        }
        else{
            Toast.makeText(this@History,"Введите все данные", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun writeData(){
        ...
        if (firstName.isNotEmpty() && lastName.isNotEmpty() && rollNo.isNotEmpty()){
            ...
            binding.editTextText2.text.clear()
            binding.editTextText3.text.clear()
            Toast.makeText(this@History,"Запись добавлена", Toast.LENGTH_SHORT).show()
        }
        else{
            Toast.makeText(this@History,"Введите все данные", Toast.LENGTH_SHORT).show()
        }
